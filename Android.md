...
If you want to see the SQL that is generated by Requery, you can enable logging on the DatabaseSource.  You typically only do this when you're debugging, so you can use the following code snippet and gradle builds will automatically strip out this code when you build a release version of your app:
